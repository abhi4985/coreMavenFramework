...
public class MAFTest {
	...
	public void verifyCNAFClick() throws InterruptedException
	{
	    ...
	    DashboardTest.logger=DashboardTest.report.createTest("Click on MAF Financier");
	...
	public void addMAFFormBasicDetails() throws InterruptedException
	{
	    ...
	    DashboardTest.logger=DashboardTest.report.createTest("Start filling MAF Form");
