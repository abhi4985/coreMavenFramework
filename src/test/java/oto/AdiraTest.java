...
public class AdiraTest  {
	...
	@Test(priority=2)
	public void verifyAdiraClick() throws InterruptedException
	{
		
	    DashboardTest.logger=DashboardTest.report.createTest("Click on Adira Financier");
		
		
	    DashboardTest.driver1.findElementByXPath(FinancerListPage.getAdiraLink()).click();
		
	    DashboardTest.logger.info("Adira Financier is clicked");
	    Thread.sleep(5000);
		
	}
	
	@Test(priority=3)
	public void addAdiraFormBasicDetails() throws InterruptedException
	{
		
	    DashboardTest.logger=DashboardTest.report.createTest("Start filling Adira Form");
		
	    DashboardTest.driver1.findElementByXPath(AdiraPage.getExistingCust()).click();
		Thread.sleep(4000);
