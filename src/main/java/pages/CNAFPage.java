...
public class CNAFPage {

	public CNAFPage(AppiumDriver driver)
	{
		PageFactory.initElements(new AppiumFieldDecorator(driver),CNAFPage.class);
		
	}

	private static String CustomerType="//android.widget.FrameLayout[@index=0]//android.view.ViewGroup[@index='5']//android.widget.ScrollView[@index='0']//android.widget.TextView[contains(@text,'Customer Type')]/parent::android.view.ViewGroup";

	private static String Individual="//android.widget.FrameLayout[@index=0]//android.view.ViewGroup[@index='5']//android.widget.ScrollView[@index='0']//android.widget.TextView[contains(@text,'Individual')]/parent::android.view.ViewGroup";
	
	private static String ExistingCustomer="//android.widget.FrameLayout[@index=0]//android.view.ViewGroup[@index='5']//android.widget.ScrollView[@index='0']//android.widget.TextView[contains(@text,'Existing Customer*')]/parent::android.view.ViewGroup";
	
	private static String Yes="//android.widget.FrameLayout[@index=0]//android.view.ViewGroup[@index='5']//android.widget.ScrollView[@index='0']//android.widget.TextView[contains(@text,'Yes')]/parent::android.view.ViewGroup";
	
	private static String CustRegion="//android.widget.FrameLayout[@index=0]//android.view.ViewGroup[@index='5']//android.widget.ScrollView[@index='0']//android.view.ViewGroup[@index='1']//android.widget.EditText[@index='2']/parent::android.view.ViewGroup";
	
	private static String CustRegionValJava="//android.widget.FrameLayout[@index=0]//android.view.ViewGroup[@index='5']//android.widget.ScrollView[@index='0']//android.widget.TextView[contains(@text,'Jawa Exclude DKI')]/parent::android.view.ViewGroup";
	
    private static String PlateNumberRegion="//android.widget.FrameLayout[@index=0]//android.view.ViewGroup[@index='5']//android.widget.ScrollView[@index='0']//android.view.ViewGroup[@index='2']//android.widget.EditText[@index='2']/parent::android.view.ViewGroup";
	
	private static String PlateNumberRegionVal="//android.widget.FrameLayout[@index=0]//android.view.ViewGroup[@index='5']//android.widget.ScrollView[@index='0']//android.widget.TextView[contains(@text,'Sumatera dan kepulauan sekitarnya')]/parent::android.view.ViewGroup";
	
	private static String Brand="//android.widget.FrameLayout[@index=0]//android.view.ViewGroup[@index='5']//android.widget.ScrollView[@index='0']//android.view.ViewGroup[@index='4']//android.view.ViewGroup[@index='1']";
	
	
	private static String SearchBrandTextbox="//android.widget.FrameLayout[@index=0]//android.view.ViewGroup[@index='6']//android.widget.EditText[contains(@text,'Search by Brand')]";
	
	
	private static String SearchBoxVal="//android.widget.FrameLayout[@index=0]//android.view.ViewGroup[@index='6']//android.widget.ScrollView[@index='3']//android.view.ViewGroup";
	
	
	private static String Model="//android.widget.FrameLayout[@index=0]//android.view.ViewGroup[@index='5']//android.widget.ScrollView[@index='0']//android.view.ViewGroup[@index='4']//android.view.ViewGroup[@index='1']";
    ...
    private static String Version="//android.widget.FrameLayout[@index=0]//android.view.ViewGroup[@index='6']//android.widget.ScrollView[@index='0']//android.view.ViewGroup[@index='5']//android.view.ViewGroup[@index='1']";
	
	private static String SearchVersionVal="//android.widget.FrameLayout[@index=0]//android.view.ViewGroup[@index='6']//android.widget.ScrollView[@index='0']//android.widget.TextView[contains(@text,'1.5L Turbo AT')]/parent::android.view.ViewGroup";
	...
	private static String VehicleTypePassenger="//android.widget.FrameLayout[@index=0]//android.view.ViewGroup[@index='6']//android.widget.ScrollView[@index='0']//android.view.ViewGroup[@index='5']//android.view.ViewGroup[@index='1']//android.widget.TextView[contains(@text,'Passenger')]";
	
	private static String MfgYear="//android.widget.FrameLayout[@index=0]//android.view.ViewGroup[@index='6']//android.widget.ScrollView[@index='0']//android.view.ViewGroup[@index='7']//android.view.ViewGroup[@index='1']";
	...
	private static String InsuranceType="//android.widget.FrameLayout[@index=0]//android.view.ViewGroup[@index='6']//android.widget.ScrollView[@index='0']//android.view.ViewGroup[@index='8']//android.view.ViewGroup[@index='1']";
    ...
    private static String MRPTextbox="//android.widget.FrameLayout[@index=0]//android.view.ViewGroup[@index='6']//android.widget.ScrollView[@index='0']//android.view.ViewGroup[@index='10']//android.widget.EditText[@index='2']";
	
	private static String PricingUpping="//android.widget.FrameLayout[@index=0]//android.view.ViewGroup[@index='6']//android.widget.ScrollView[@index='0']//android.view.ViewGroup[@index='11']//android.view.ViewGroup[@index='1']";
	
	private static String PricingUppingVal="//android.widget.FrameLayout[@index=0]//android.view.ViewGroup[@index='6']//android.widget.ScrollView[@index='0']//android.widget.TextView[contains(@text,'0')]/parent::android.view.ViewGroup";
	
	private static String ContinueButton="//android.widget.FrameLayout[@index=0]//android.view.ViewGroup[@index='6']//android.widget.ScrollView[@index='0']//android.view.ViewGroup[@index='12']";
	...
	private static String BranchNameVal="//android.widget.FrameLayout[@index=0]//android.view.ViewGroup[@index='10']//android.widget.ScrollView[@index='3']//android.widget.TextView[contains(@text,'DSF Gresik')]/parent::android.view.ViewGroup";
	...
	{
		System.out.println("trying to find the Customer Type dropdown");
		return CustomerType;
	...
	{
		System.out.println("trying to find the Individual value in dropdown");
		return Individual;
		
		
	}
	
	public static String getExistingCustomer()
	{
		System.out.println("trying to find the ExistingCustomer value in dropdown");
	...
	{
		System.out.println("trying to find the Yes value in dropdown");
		return Yes;
	...
	{
		System.out.println("trying to find the VehicleType dropdown");
		return VehicleType;
		
		
	}
	
	public static String getVehicleTypePassenger()
	{
		System.out.println("trying to find the VehicleTypePassenger");
		return VehicleTypePassenger;
	...
	public static String getPricingUpping()
	{
		System.out.println("trying to find the PricingUpping");
		return PricingUpping;
		
		
	}
	public static String getPricingUppingVal()
	{
		System.out.println("trying to find the PricingUppingVal");
		return PricingUppingVal;
