...
public class Addstockpage {
	...
	private static String Version="//android.widget.FrameLayout[@index=0]//android.view.ViewGroup[@index='4']//android.view.ViewGroup[@index='2']/android.widget.ScrollView[@index='0']//android.view.ViewGroup[@index='1']/android.view.ViewGroup[@index='0']/android.view.ViewGroup[@index='1']";
    ...
    private static String OKbutton="//android.widget.FrameLayout[@index=0]//android.view.ViewGroup[@index='4']//android.widget.ScrollView[@index='0']//android.view.ViewGroup[@index=2']//android.widget.TextView[contains(@text,'Okay')]";
	...
	private static String kmsdriven="//android.widget.FrameLayout[@index='0']//android.view.ViewGroup[@index='4']//android.widget.ScrollView[@index='0']//android.view.ViewGroup[@index='5']/android.widget.EditText[@index='2']";
    ...
    private static String Regmonthandyear="//android.widget.Framelayout[@index='0']//android.view.ViewGroup[@index='4']//android.widget.ScrollView[@index='0']//android.widget.TextView[@contains(@text,'Registration Month and Year*')]/parent::android.view.ViewGroup";
    
    private static String Regmonthandyearselection="//android.widget.Framelayout[@index='0']//android.view.ViewGroup[@index='4']//android.view.ViewGroup[@index='3']//android.widget.TextView[contains@text,'Okay']";
