...
public class MUFFinancerPage{
	
	 
	
	// Initialize the Page objects using driver having capabilities
	public MUFFinancerPage(AppiumDriver driver)
	{
		PageFactory.initElements(new AppiumFieldDecorator(driver),MUFFinancerPage.class);
		
	}

	private static String CustomerType="//android.widget.FrameLayout[@index=0]//android.view.ViewGroup[@index='6']//android.widget.ScrollView[@index='0']//android.widget.TextView[contains(@text,'Customer/Branch Region*')]/parent::android.view.ViewGroup";

	private static String CustomerTypeVal="//android.widget.FrameLayout[@index=0]//android.view.ViewGroup[@index='6']//android.widget.ScrollView[@index='0']//android.widget.TextView[contains(@text,'Jakarta & Sekitarnya')]/parent::android.view.ViewGroup";
	...
	private static String CustRegionValJava="//android.widget.FrameLayout[@index=0]//android.view.ViewGroup[@index='6']//android.widget.ScrollView[@index='0']//android.widget.TextView[contains(@text,'Permanent employee')]/parent::android.view.ViewGroup";
	
    private static String PlateNumberRegion="//android.widget.FrameLayout[@index=0]//android.view.ViewGroup[@index='6']//android.widget.ScrollView[@index='0']//android.view.ViewGroup[@index='2']//android.widget.EditText[@index='2']/parent::android.view.ViewGroup";
	...
	private static String Brand="//android.widget.FrameLayout[@index=0]//android.view.ViewGroup[@index='6']//android.widget.ScrollView[@index='0']//android.view.ViewGroup[@index='3']//android.view.ViewGroup[@index='1']";
	...
	private static String Model="//android.widget.FrameLayout[@index=0]//android.view.ViewGroup[@index='6']//android.widget.ScrollView[@index='0']//android.view.ViewGroup[@index='4']//android.view.ViewGroup[@index='1']";
	...
	private static String SearchVersionVal="//android.widget.FrameLayout[@index=0]//android.view.ViewGroup[@index='6']//android.widget.ScrollView[@index='0']//android.widget.TextView[contains(@text,'2.4 VTI AT')]/parent::android.view.ViewGroup";
	...
	private static String InsuranceTypeVal="//android.widget.FrameLayout[@index=0]//android.view.ViewGroup[@index='6']//android.widget.ScrollView[@index='0']//android.widget.TextView[contains(@text,'Total Loss Only')]/parent::android.view.ViewGroup";
	...
	private static String PricingUpping="//android.widget.FrameLayout[@index=0]//android.view.ViewGroup[@index='6']//android.widget.ScrollView[@index='0']//android.view.ViewGroup[@index='12']//android.view.ViewGroup[@index='1']";
	...
	private static String LoanType="//android.widget.FrameLayout[@index=0]//android.view.ViewGroup[@index='9']//android.widget.ScrollView[@index='2']/android.view.ViewGroup[@index='0']/android.view.ViewGroup[@index='0']/android.view.ViewGroup[@index='6']//android.widget.TextView[contains(@text,'Loan Type*')]/parent::android.view.ViewGroup";
	
	private static String LoanTypeVal="//android.widget.FrameLayout[@index=0]//android.view.ViewGroup[@index='9']//android.widget.ScrollView[@index='0']//android.widget.TextView[contains(@text,'Conventional')]/parent::android.view.ViewGroup";
	
	
	private static String FinancierBranch="//android.widget.FrameLayout[@index=0]//android.view.ViewGroup[@index='9']//android.widget.ScrollView[@index='2']/android.view.ViewGroup[@index='0']/android.view.ViewGroup[@index='0']/android.view.ViewGroup[@index='8']//android.widget.TextView[contains(@text,'Financier Branch*')]/parent::android.view.ViewGroup";
	...
	private static String BranchNameVal="//android.widget.FrameLayout[@index=0]//android.view.ViewGroup[@index='10']//android.widget.ScrollView[@index='3']//android.widget.TextView[contains(@text,'MUF Bekasi')]/parent::android.view.ViewGroup";
	
	private static String selectall="//android.widget.FrameLayout[@index=0]//android.view.ViewGroup[@index='9']//android.widget.ScrollView[@index='2']//android.view.ViewGroup[@index='10']/android.widget.ImageView[@index='0']";
	...
	public static String getCustomerTypeVal()
	{
	...
	{
		System.out.println("trying to find the LoanType");
		return LoanType;
		
		
	}
	
	public static String getLoanTypeVal()
	{
		System.out.println("trying to find the LoanTypeVal");
		return LoanTypeVal;
