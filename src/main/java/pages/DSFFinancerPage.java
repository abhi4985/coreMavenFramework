...
public class DSFFinancerPage{
	
	 
	
	// Initialize the Page objects using driver having capabilities
	public DSFFinancerPage(AppiumDriver driver)
	{
		PageFactory.initElements(new AppiumFieldDecorator(driver),DSFFinancerPage.class);
		
	}

	private static String CustomerType="//android.widget.FrameLayout[@index=0]//android.view.ViewGroup[@index='6']//android.widget.ScrollView[@index='0']//android.widget.TextView[contains(@text,'Customer Type')]/parent::android.view.ViewGroup";

	private static String Individual="//android.widget.FrameLayout[@index=0]//android.view.ViewGroup[@index='6']//android.widget.ScrollView[@index='0']//android.widget.TextView[contains(@text,'Individual')]/parent::android.view.ViewGroup";
	...
	private static String CustRegionValJava="//android.widget.FrameLayout[@index=0]//android.view.ViewGroup[@index='6']//android.widget.ScrollView[@index='0']//android.widget.TextView[contains(@text,'Java')]/parent::android.view.ViewGroup";
	...
	private static String PlateNumberRegionVal="//android.widget.FrameLayout[@index=0]//android.view.ViewGroup[@index='6']//android.widget.ScrollView[@index='0']//android.widget.TextView[contains(@text,'Sumatera dan kepulauan')]/parent::android.view.ViewGroup";
