...
public class BuanaPage{
	
	 
	
	// Initialize the Page objects using driver having capabilities
	public BuanaPage(AppiumDriver driver)
	{
		PageFactory.initElements(new AppiumFieldDecorator(driver),BuanaPage.class);
		
	}

	
    private static String PlateNumberRegion="//android.widget.FrameLayout[@index=0]//android.view.ViewGroup[@index='6']//android.widget.ScrollView[@index='0']//android.view.ViewGroup[@index='0']//android.widget.EditText[@index='2']/parent::android.view.ViewGroup";
	
	private static String PlateNumberRegionVal="//android.widget.FrameLayout[@index=0]//android.view.ViewGroup[@index='6']//android.widget.ScrollView[@index='0']//android.widget.TextView[contains(@text,'BL, BK, BB, BA, BG, BN, BE')]/parent::android.view.ViewGroup";
	
	private static String Brand="//android.widget.FrameLayout[@index=0]//android.view.ViewGroup[@index='6']//android.widget.ScrollView[@index='0']//android.view.ViewGroup[@index='1']//android.view.ViewGroup[@index='1']";
	...
	private static String Model="//android.widget.FrameLayout[@index=0]//android.view.ViewGroup[@index='6']//android.widget.ScrollView[@index='0']//android.view.ViewGroup[@index='2']//android.widget.EditText[@index='2']";
	

	
    private static String Version="//android.widget.FrameLayout[@index=0]//android.view.ViewGroup[@index='6']//android.widget.ScrollView[@index='0']//android.view.ViewGroup[@index='3']//android.widget.EditText[@index='2']";
	
    private static String VehicleType="//android.widget.FrameLayout[@index=0]//android.view.ViewGroup[@index='6']//android.widget.ScrollView[@index='0']//android.view.ViewGroup[@index='5']//android.widget.EditText[@index='2']/parent::android.view.ViewGroup";
	...
	{
		System.out.println("trying to find the VehicleTypeVal dropdown");
