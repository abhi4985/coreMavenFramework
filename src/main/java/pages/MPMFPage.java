...
public class MPMFPage{
	
	 
	
	// Initialize the Page objects using driver having capabilities
	public MPMFPage(AppiumDriver driver)
	{
		PageFactory.initElements(new AppiumFieldDecorator(driver),MPMFPage.class);
	...
	private static String CustRegionValJava="//android.widget.FrameLayout[@index=0]//android.view.ViewGroup[@index='6']//android.widget.ScrollView[@index='0']//android.widget.TextView[contains(@text,'Sumbagut')]/parent::android.view.ViewGroup";
	
    private static String PlateNumberRegion="//android.widget.FrameLayout[@index=0]//android.view.ViewGroup[@index='6']//android.widget.ScrollView[@index='0']//android.view.ViewGroup[@index='1']//android.widget.EditText[@index='2']/parent::android.view.ViewGroup";
    ...
    private static String Version="//android.widget.FrameLayout[@index=0]//android.view.ViewGroup[@index='6']//android.widget.ScrollView[@index='0']//android.view.ViewGroup[@index='4']//android.widget.EditText[@index='2']";
	
    private static String VehicleType="//android.widget.FrameLayout[@index=0]//android.view.ViewGroup[@index='6']//android.widget.ScrollView[@index='0']//android.view.ViewGroup[@index='5']//android.view.ViewGroup[@index='1']";
	...
	private static String BranchNameVal="//android.widget.FrameLayout[@index=0]//android.view.ViewGroup[@index='10']//android.widget.ScrollView[@index='3']//android.widget.TextView[contains(@text,'MPMF Semarang')]/parent::android.view.ViewGroup";
